    ...
    <div class="decorative-bg">
      <div class="profile-section">
        ...
        <div class="profile-info">
          <div class="profile-name">kelvin02</div>
          <div class="profile-balance">฿ 0.00</div>
        </div>
      </div>
    </div>
    ...
    <div class="main-content">
      ...
      <div class="days-grid">
        ...
        >
          ...
          <div class="reward-text" v-html="reward"></div>
          <button
            class="sign-in-btn"
      ...
      <div class="single-day-card">
        ...
        <div class="reward-icon"></div>
        <div class="reward-text">วันที่ 7: ลงปาก<br>ส์คืนมากกว่า</div>
        <button
          class="sign-in-btn"
          :disabled="signedInDays.includes(6)"
          @click="signIn(6)"
        >
          {{ signedInDays.includes(6) ? "Signed In" : "Sign In" }}
        </button>
      </div>
    </div>
